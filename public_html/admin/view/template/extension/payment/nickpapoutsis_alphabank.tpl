...
<input type="text" name="nickpapoutsis_alphabank_css_url" value="<?php echo $nickpapoutsis_alphabank_css_url; ?>" placeholder="Optional CSS URL - for example: <?php echo $HTTPS_CATALOG; ?>alphabank.css" id="input-css-url" class="form-control"/>
</div>
</div>
</div>
...
<div class="col-sm-10">
<div class="input-group"> <span class="input-group-addon"><i class="fas fa-check-circle" style="font-size:1.4em; padding-right: 4px;"></i></span>
<input type="text" name="nickpapoutsis_alphabank_live_url" value="<?php echo $nickpapoutsis_alphabank_live_url; ?>" placeholder="<?php echo $entry_live_url; ?>" id="input-live-url" class="form-control"/>
</div>
</div>
</div>

<div class="form-group">
<label class="col-sm-2 control-label" for="input-test-url"><?php echo $entry_test_url; ?></label>
<div class="col-sm-10">
<div class="input-group"> <span class="input-group-addon"><i class="fas fa-times-circle" style="font-size:1.4em; padding-right: 4px;"></i></span>
<input type="text" name="nickpapoutsis_alphabank_test_url" value="<?php echo $nickpapoutsis_alphabank_test_url; ?>" placeholder="<?php echo $entry_test_url; ?>" id="input-test-url" class="form-control"/>
</div>
</div>
</div>

...
<?php foreach ($products as $product): ?>
  ...
  <div class="product-layout <?php echo $j3->classes($product['classes']); ?> <?php echo $classes; ?>">
    <div class="side-product">
      <div class="image">
        <a href="<?php echo $product['href']; ?>" <?php if (isset($ee_tracking) && $ee_tracking && $ee_click) { ?>onclick="ee_product.click('<?php echo $product['product_id']; ?>', '<?php echo isset($product['ee_position']) ? $product['ee_position'] : ''; ?>', '<?php echo isset($ee_type) ? $ee_type : ''; ?>')"<?php } ?> class="product-img">

  ...
  <div class="col-sm-6">
    ...
    <div class="buttons">
      <div class="pull-right">
        <button type="button" id="button-account" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><span><?php echo $button_continue; ?></span></button>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    ...
    <div class="buttons">
      <div class="pull-right">
        <button type="button" id="button-login" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary"><span><?php echo $button_login; ?></span></button>
      </div>
    </div>
  </div>
</div>

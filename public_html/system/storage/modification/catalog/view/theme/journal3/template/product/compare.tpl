        ...
        <tr>
          ...
          <?php foreach ($products as $product) { ?>
            ...
            <td class="<?php echo $j3->classes(\Journal3\Utils\Arr::get($product, 'classes')); ?> <?php echo $classes; ?>"><div class="compare-buttons">
              ...
              <button class="btn btn-primary btn-cart" <?php if (isset($ee_tracking) && $ee_tracking && $ee_cart) { ?>data-eet-position="<?php echo isset($product['ee_position']) ? $product['ee_position'] : ''; ?>" data-eet-type="<?php echo isset($ee_type) ? $ee_type : ''; ?>"<?php } ?> onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');" ><span><?php echo $button_cart; ?></span></button>
              <?php endif; ?>

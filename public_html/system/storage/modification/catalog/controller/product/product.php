...
class ControllerProductProduct extends Controller {
	...
	public function index() {
        ...
        $data['bp_product_badge_event'] = '';

        $bp_product_badge = false;

        if ($this->config->get('bestprice_analytics_product_badge_status')) {
            $bp_product_badge = true;
        } else if ($this->config->get('config_bestprice_analytics_product_badge_status')) {
            $bp_product_badge = true;
        }

        if ($bp_product_badge) {

                $data['bp_product_badge_event'] .= "<!-- BestPrice Product Badge start -->"."\n";
                $data['bp_product_badge_event'] .= "<script data-mid='" . $this->config->get('bestprice_analytics_product_badge_mid') . "' data-pid='" . $this->request->get['product_id'] . "' src='https://scripts.bestprice.gr/pbadge.js' async='true'>" . "\n";
                $data['bp_product_badge_event'] .= "</script>" . "\n";
                $data['bp_product_badge_event'] .= "<noscript><a href='https://www.bestprice.gr'>BestPrice.gr</a></noscript>";
                $data['bp_product_badge_event'] .= "<!-- BestPrice Product Badge end -->";

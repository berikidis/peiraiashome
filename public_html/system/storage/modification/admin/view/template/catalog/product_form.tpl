              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label" for="input-customtext<?php echo $language['language_id']; ?>">Custom Text</label>
                    <div class="col-sm-10">
                      <textarea class="form-control" name="product_customtext[<?php echo $language['language_id']; ?>][customtext]" placeholder="Enter Your Custom Text" id="input-customtext<?php echo $language['language_id']; ?>"><?php echo isset($product_customtext[$language['language_id']]) ? $product_customtext[$language['language_id']]['customtext'] : ''; ?></textarea>
                    </div>
                 </div>
                 <div class="form-group">

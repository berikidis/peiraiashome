...
//karapuz (ka_csv_product_import.ocmod.xml) 
	static protected $last_product_id = false;
			...
			$this->db->query("UPDATE " . DB_PREFIX . "product SET image = '" . $this->db->escape($data['image']) . "' WHERE product_id = '" . (int)$product_id . "'");
				...
				if (isset($data['product_customtext'])) {
					foreach ($data['product_customtext'] as $language_id => $value) {
						if (trim($value['customtext']) != '') {
							$this->db->query("INSERT INTO " . DB_PREFIX . "product_customtext SET product_id = '" . (int)$product_id . "', language_id = '" . (int)$language_id . "', customtext = '" . trim($this->db->escape($value['customtext'])) . "'");
						}
					}
				}

<?php 
class ControllerExtensionFeedParseDeleteGablias extends Controller {
	...
	private function getAllXMLproducts(){
		$query = $this->db->query("SELECT product_id FROM " . DB_PREFIX . "product WHERE gablias_flag = '1'");

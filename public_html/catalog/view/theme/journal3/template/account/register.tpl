...
<div id="account-register" class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php $class = 'col-sm-12'; ?>
    <?php } ?>
    <div id="content" class="<?php echo $class; ?> register-page">
...
<?php endif; // isPopup() ?>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="register-form form-horizontal">
        <div id="account">
          <legend><?php echo $text_your_details; ?></legend>
          <div class="form-group required account-customer-group" style="display: <?php echo (count($customer_groups) > 1 ? 'block' : 'none'); ?>;">
          ...
          <div class="form-group <?php if ($j3->settings->get('accountAccountFirstNameField') === 'required'): ?>required<?php endif; ?> account-firstname">
          ...
          <div class="form-group <?php if ($j3->settings->get('accountAccountLastNameField') === 'required'): ?>required<?php endif; ?> account-lastname">
          ...
          <div class="form-group <?php if ($j3->settings->get('accountAccountTelephoneField') === 'required'): ?>required<?php endif; ?> account-telephone">
          ...
          <div class="form-group <?php if ($j3->settings->get('accountAccountFaxField') === 'required'): ?>required<?php endif; ?> account-fax">
        ...
        <div id="address">
          ...
          <div class="form-group <?php if ($j3->settings->get('accountAddressCompanyField') === 'required'): ?>required<?php endif; ?> address-company">
          ...
          <div class="form-group <?php if ($j3->settings->get('accountAddressAddress1Field') === 'required'): ?>required<?php endif; ?> address-address-1">
          ...
          <div class="form-group <?php if ($j3->settings->get('accountAddressAddress2Field') === 'required'): ?>required<?php endif; ?> address-address-2">
          ...
          <div class="form-group <?php if ($j3->settings->get('accountAddressCityField') === 'required'): ?>required<?php endif; ?> address-city">
          ...
          <div class="form-group <?php if ($j3->settings->get('accountAddressCountryField') === 'required'): ?>required<?php endif; ?> address-country">
          ...
          <div class="form-group <?php if ($j3->settings->get('accountAddressRegionField') === 'required'): ?>required<?php endif; ?> address-zone">
        ...
        <fieldset>
          ...
          <div class="form-group required account-pass">
       ...
       <!-- <fieldset>
        ...
        <div class="buttons">
          <div class="pull-right"><?php echo $text_agree; ?>
            ...
            <?php } ?>
            <button type="submit" class="btn btn-primary" data-loading-text="<span><?php echo $button_continue; ?></span>"><span><?php echo $button_continue; ?></span></button>
          </div>
        </div>
        <?php } else { ?>
        <div class="buttons">

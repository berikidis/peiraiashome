...
$SOURCE_FOLDER = dirname(__FILE__) . "/upload/makistselios/";
$SOURCE_FILENAME = "";

$SOURCE_FEED  = "https://www.makistselioshome.gr/index.php?route=feed/product_feed";
...
$DEFAULT_MAIN_CATEGORY_ID = 367;	// Default category for new products
...
$DEFAULT_MANUFACTURER_ID = 55;		// Default Manufacturer
...
// IMAGE UPLOADING
$IMAGES_LOCAL_DIR = "../image/catalog/products/makistselios/";
$IMAGES_PATH = "catalog/products/makistselios/";

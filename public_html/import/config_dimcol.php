...
$SOURCE_FOLDER = dirname(__FILE__) . "/upload/dimcol/";
$SOURCE_FILENAME = "";

$SOURCE_FEED  = "https://www.dimcol.gr/files/exportimport/products.xml";
...
$DEFAULT_MAIN_CATEGORY_ID = 166;	// Default category for new products
...
$DEFAULT_MANUFACTURER_ID = 30;		// Default Manufacturer
...
// IMAGE UPLOADING
$IMAGES_LOCAL_DIR = "../image/catalog/products/dimcol/";
$IMAGES_PATH = "catalog/products/dimcol/";

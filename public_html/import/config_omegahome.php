...
$SOURCE_FOLDER = dirname(__FILE__) . "/upload/omegahome/";
$SOURCE_FILENAME = "";

$SOURCE_FEED  = "https://oliver.baby/FeedAPI.php?method=retrieve&type=b2b&shop=www.oliver.baby&token=xaF4AFJ5vF92M2dGHVwf2orU5dPMzg";
...
$DEFAULT_MAIN_CATEGORY_ID = 348;	// Default category for new products
...
$DEFAULT_MANUFACTURER_ID = 56;		// Default Manufacturer
...
// IMAGE UPLOADING
$IMAGES_LOCAL_DIR = "../image/catalog/products/omegahome/";
$IMAGES_PATH = "catalog/products/omegahome/";

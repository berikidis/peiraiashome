...
$SOURCE_FOLDER = dirname(__FILE__) . "/upload/teoran/";
$SOURCE_FILENAME = "";

$SOURCE_FEED = "https://teoran.gr/index.php?route=extension/feed/teoran_feed_separated";
...
$JOB_UPDATE_CATEGORY = false;		// Update Product Category Default: false
...
$DEFAULT_MAIN_CATEGORY_ID = 219;	// Default category for new products
...
$DEFAULT_MANUFACTURER_ID = 20;		// Default Manufacturer
...
// IMAGE UPLOADING
$IMAGES_LOCAL_DIR = "../image/catalog/products/teoran/";
$IMAGES_PATH = "catalog/products/teoran/";

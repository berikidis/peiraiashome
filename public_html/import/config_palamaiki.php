...
$SOURCE_FOLDER = dirname(__FILE__) . "/upload/palamaiki/";
$SOURCE_FILENAME = "";

$SOURCE_FEED  = "https://palamaiki.gr/feeds/catalog.xml";
$SOURCE_FEED_AUTH_USERNAME = 'palamaiki_user';
$SOURCE_FEED_AUTH_PASSWORD = 'Wq@kBsz^M%Ze5LS3';
...
$JOB_UPDATE_CATEGORY = false;		// Update Product Status. Default: false
...
// DATA FORMATING
$PRODUCT_NAME_UPPERCASE = true;		// Convert product name to upper case - Default: false


// IMAGE UPLOADING
$IMAGES_LOCAL_DIR = "../image/catalog/products/palamaiki/";
$IMAGES_PATH = "catalog/products/palamaiki/";
$IMAGES_MAX_UPLOAD = 50;

$GOOGLE_DRIVE_API_KEY = "AIzaSyAvPjgSDHOBksIbgGbGpCq42_SVg1bdCMs";

...
if (!isset($request->server['HTTP_X_REQUESTED_WITH']) && defined("IS_DEBUG") && IS_DEBUG) {
    ...
    <div id="debug-wrapper">
        <div id="debug-panel-header">
            <b>DEBUG PANEL</b> <span style="color:red">(by Digital Elephant)</span>
            <div id="debug-toggle"><i class="fa fa-angle-right" aria-hidden="true"></i></div>
        </div>
        <div id="debug-panel-body">
            <ul class="nav nav-tabs">
                <li class="active"><a data-toggle="tab" href="#debug-panel-tab-action">Actions</a></li>
            ...
            <div class="tab-content">
                ...
                <div id="debug-panel-tab-request" class="tab-pane fade">
                    <h3>Requests</h3>
                    <h4>GET <kbd><?= (!empty($request->get)) ? count($request->get) : 0 ?></kbd>:</h4>
                    ...
                    <h4>POST <kbd><?= (!empty($request->post)) ? count($request->post) : 0 ?></kbd>:</h4>
                    <?php if (!empty($request->post)) { ?>
                        <table class="table table-hover table-bordered">
                            <thead>
                            <tr>
                                <td>Key</td>
                    ...
                    <h4>SERVER <kbd><?= (!empty($request->server)) ? count($request->server) : 0 ?></kbd>:</h4>
                    <?php if (!empty($request->server)) { ?>
                        <table class="table table-hover table-bordered">
                            <thead>
                            <tr>
                                <td>Key</td>
                            ...
                            <tbody>
                            <?php foreach ($request->server as $key => $value) { ?>
                                <tr>
                                    <td>
                                        <?= $key ?>
                                    </td>
                    ...
                    <h4>COOKIE <kbd><?= (!empty($request->cookie)) ? count($request->cookie) : 0 ?></kbd>:</h4>

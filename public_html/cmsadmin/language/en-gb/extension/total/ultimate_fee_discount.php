...
$_['entry_distance_calculation']		= 'Distance Calculation: <div class="help-text">Select the way distances are calculated. To change the origin of distance calculations, add a Setting Override rule to the ' . $row . ', and choose to override "config_address".</div>';
...
$_['text_text_error']					= 'Text (Error)';
$_['text_text_success']					= 'Text (Success)';
$_['text_text_warning']					= 'Text (Warning)';
...
$_['help_charge_type']					= 'Select the basis for the charge:<br /><br />&bull; A simple flat charge or per item charge<br /><br />&bull; A charge based on brackets (quantity, total, weight, etc.)';
$_['help_charge_charges']				= 'For "Simple Charges", enter the flat charge or per item charge (such as 5.00) or a percentage (such as 10%).<hr />For "Bracket Charges", separate brackets by commas or new lines, and enter them in the format:<br /><br /><b>From - To = Cost / Per</b><br /><br />The "Per" value is optional. If you leave out the "From" value, it will default to the previous bracket&#39;s "To" value (or 0 for the first bracket).<br /><br />For example, to charge $6.00 for 1 to 3 items, and $2.00 per item for 4 or more items, you would choose "Quantity" and enter:<br /><div class="text-left" style="margin: 10px">1-3 = 6.00<br />4-9999 = 2.00 / 1</div>';
...
$_['help_total_value']					= 'The cart&#39;s Sub-Total is normally used for calculations involving the total. To change this, use one of the following:<br /><br />&bull; <b>Pre-Discounted Sub-Total:</b> the sub-total of all products&#39; original prices, ignoring Special or Discount prices<br /><br />&bull; <b>Non-Discounted Sub-Total:</b> the sub-total not including products with Special or Discount pricing' . ($type == 'Shipping' ? '' : '<br /><br />&bull; <b>Shipping Cost:</b> the cost of the shipping option selected by the customer') . '<br /><br />&bull; <b>Taxed Sub-Total:</b> the sub-total including any tax on products<br /><br />&bull; <b>Total:</b> the total at the relative Sort Order of ' . ($type == 'Shipping' ? 'the "Shipping" Order Total<br /><br />Products that do not require shipping are NOT included in values based on the sub-total.' : 'this extension.');
...
$_['help_custom_field']					= 'Enter a custom field name in the auto-complete field. Make sure to leave the custom_field_id in the square brackets [ and ] since that is used for comparison purposes.';
$_['help_custom_field_value']			= 'Enter a custom field value, or multiple values separated by commas. Products that have the specified custom field with this value will be eligible for this ' . $row . '. Leave this field blank to allow for any custom field value.';
...
$_['help_past_orders']					= 'For "Product", "Order Status", and "Manufacturer" comparisons, enter the product_id, order_status_id, or manufacturer_id in this field. Separate multiple values using commas.<br /><br />For other comparison types, enter a minimum value (such as 5) or a range (such as 50.00-100.00) that the customer&#39;s past orders must meet. A single value indicates <b>at least</b> that value.<br /><br />Ranges are inclusive of the end values. Separate multiple ranges using commas. To specify an exact value, use a range like 50.00-50.00.';
...
$_['help_combination_groups_required']	= 'If a Group is required for this Charge Combination to be enabled, enter it here. Separate multiple Group values with commas.';
...
//------------------------------------------------------------------------------
$_['text_highest_product_tax_rate']		= '(Highest Product Tax Rate)';
$_['text_ignoreoptions_subtotal']		= 'Sub-Total Ignoring Options';

$_['text_other_charges']				= 'Other Charges';
$_['text_buy_x_for_y']					= 'Buy X For $Y';
$_['text_buy_x_get_y']					= 'Buy X Get Y Z% Off';

$_['help_charge_type']					= 'Select the basis for the charge. Help text for "Simple Charges" and "Bracket Charges" are within the tooltip for the Charge box.<hr />For "Buy X For $Y" charges, the syntax you want to use is:<br /><br /><b>X = Y</b><br /><br />For example, a "Buy 3 For $10.00" discount would be:<br /><br />3 = 10.00<hr />For "Buy X Get Y Z% Off" charges, the syntax you want to use is:<br /><br /><b>X = Y / Z</b><br /><br />For example, a "Buy 2 Get 1 50% Off" discount would be:<br /><br />2 = 1 / 50%<hr />For both types of charges, to make the discount only apply once, you can use a bracket (e.g. 3-9999) as the X value.';

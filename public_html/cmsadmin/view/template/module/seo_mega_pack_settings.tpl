						...
						<div class="row">
							...
							<div class="col-md-11">
								...
								<blockquote>
									...
									<br><br>
									<p>
										<?php echo $s_smp_custom_language_code_aliases; ?>
									</p>
										<table class="table table-tbody" style="margin: 0">
											<?php foreach( $languages as $language ) { ?>
												<tr>
													...
													<td  class="vertical-middle">
														<input 
															type="text" 
															class="form-control" 
															name="smp_language_code_alias[<?php echo $language['code']; ?>]" 
															value="<?php echo ! empty( $settings['smp_language_code_alias'][$language['code']] ) ? $settings['smp_language_code_alias'][$language['code']] : ''; ?>" 
														/>
													</td>
												</tr>
											<?php } ?>

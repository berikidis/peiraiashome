  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-input" data-toggle="tooltip" title="<?php echo KaGlobal::t('button_save'); ?>" class="btn btn-primary"><i class="fa fa-check-circle"></i> <?php echo KaGlobal::t('button_save'); ?></button>
        <a href="<?php echo $cancel; ?>" data-toggle="tooltip" title="<?php echo KaGlobal::t('button_cancel'); ?>" class="btn btn-default"><i class="fa fa-reply"></i>  <?php echo KaGlobal::t('button_cancel'); ?></a>
      </div>
	...
	<div class="container-fluid">
      ...
      <ul class="nav nav-tabs">
        ...
        <li><a href="#tab-separators" data-toggle="tab"><?php echo KaGlobal::t('Separators'); ?></a></li>
        <li><a href="#tab-optimization" data-toggle="tab"><?php echo KaGlobal::t('Optimization'); ?></a></li>
      </ul>
						...
						<tbody>
							...
							<tr>
								...
								<td class="left">
									...
									<a onclick="$(this).parent().find(':checkbox').attr('checked', true);"><?php echo KaGlobal::t('text_select_all'); ?></a> / <a onclick="$(this).parent().find(':checkbox').attr('checked', false);"><?php echo KaGlobal::t('text_unselect_all'); ?></a>
								</td>
							</tr>

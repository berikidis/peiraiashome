...
<div id="content">
  ...
  <?php if (!empty($is_wrong_db)) { ?>
    ...
    <?php echo KaGlobal::t('Database is not compatible...'); ?>
  ...
  <?php } elseif ($params['step'] == 1) { ?>
		...
		<div class="page-header">
			<div class="container-fluid">
				<div class="pull-right">
					<button type="submit" form="form-input" class="btn btn-primary"><?php echo KaGlobal::t('Next'); ?></button>
				</div>
				<h1><?php echo $heading_title; ?>: <?php echo KaGlobal::t('STEP 1 of 3'); ?></h1>
		...
		<div class="container-fluid">
			...
			<?php echo KaGlobal::t('This page allows you to export...'); ?><br /><br />
			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-input">
				...
				<table class="table table-condensed table-striped table-hover">
					<tr>
						<td width="25%"><label class="control-label"><span data-toggle="popover" data-content="<?php echo htmlspecialchars(KaGlobal::t('Profiles may store export p...')); ?>"><?php echo KaGlobal::t('Profile'); ?></span></label></td>
						<td colspan="2">
							<?php if (!empty($profiles)) { ?>
							 ...
							 <?php } else { ?>
								<?php echo KaGlobal::t('no profiles present'); ?>
							 <?php } ?>
						</td>
					</tr>
				</table>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="tab-general">
						<table class="table table-condensed table-striped table-hover">
							<tr>
								...
								<td>
									<input style="vertical-align: middle;" type="radio" id="default_file_setting" name="file_settings" onclick="javascript: onFileSettings('custom');" value="custom" <?php if ($params['file_settings'] == 'custom') { ?> checked="checked" <?php } ?> /> <?php echo KaGlobal::t('custom'); ?>&nbsp;&nbsp;
									<input style="vertical-align: middle;" type="radio" name="file_settings" onclick="javascript: onFileSettings('msexcel');" value="msexcel" <?php if ($params['file_settings'] == 'msexcel') { ?> checked="checked" <?php } ?> /> <?php echo KaGlobal::t('best for opening in MS Excel'); ?>
								</td>
								<td width="50%">&nbsp;</td>
							</tr>
							<tr>
								<td width="25%"><label class="control-label"><span data-toggle="popover" data-content="<?php echo KaGlobal::t('the \'tab\' delimiter is reco...'); ?>"><?php echo KaGlobal::t('Field Delimiter'); ?></span></label></td>
								<td>
									<select name="delimiter" style="width:300px;" onchange="javascript: onFileSettingsChange();">
										<option <?php if ($params['delimiter'] == 't') { ?>selected="selected" <?php } ?>value="t"><?php echo KaGlobal::t('tab'); ?></option>
										<option <?php if ($params['delimiter'] == 's') { ?>selected="selected" <?php } ?>value="s"><?php echo KaGlobal::t('semicolon'); ?> ";"</option>
										<option <?php if ($params['delimiter'] == 'c') { ?>selected="selected" <?php } ?>value="c"><?php echo KaGlobal::t('comma'); ?> ","</option>
									</select>
								</td>
								<td width="50%">&nbsp;</td>
							</tr>
							<tr>
								<td width="25%"><label class="control-label"><span data-toggle="popover" data-content="<?php echo KaGlobal::t('You have to keep in mind th...'); ?>"><?php echo KaGlobal::t('File Charset'); ?></span></label></td>
								<td colspan="2">
									...
									<table width="500px">
										...
										<tr id="custom_charset_row" <?php if ($params['charset_option'] == 'predefined') { ?> style="display:none" <?php } ?>>
											<td width="250px">
												...
												<br /><a href="javascript: void(0);" onclick="javascript: activateCharset('predefined');"><?php echo KaGlobal::t('select from predefined values'); ?></a>
											</td>
											<td>&nbsp;</td>
										</tr>
									</table>
							...
							<tr>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Store'); ?></label></td>
								<td>              
							...
							<tr>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Language'); ?></label></td>
								<td>
							...
							<tr>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Products From Categories'); ?></label></td>
								<td colspan="2">
										<input type="radio" name="products_from_categories" onclick="javascript: showCategories('all');" value="all" <?php if ($params['products_from_categories'] == 'all') { ?> checked="checked" <?php } ?> /><?php echo KaGlobal::t('All'); ?>&nbsp;&nbsp;
										<input type="radio" name="products_from_categories" onclick="javascript: showCategories('selected');" value="selected" <?php if ($params['products_from_categories'] == 'selected') { ?> checked="checked" <?php } ?> /><?php echo KaGlobal::t('Selected'); ?>
								</td>
							</tr>
							<tr id="export_selected_categories" <?php if ($params['products_from_categories'] != 'selected') { ?>style="display:none" <?php } ?>>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Categories'); ?></label></td>
								<td colspan="2">
										...
										<a onclick="$(this).parent().find(':checkbox').prop('checked', true);"><?php echo KaGlobal::t('Select All'); ?></a> / <a onclick="$(this).parent().find(':checkbox')..prop('checked', false);"><?php echo KaGlobal::t('Unselect All'); ?></a>
								</td>
							</tr>
							<tr>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Products From Manufacturers'); ?></label></td>
								<td colspan="2">
										<input type="radio" name="products_from_manufacturers" onclick="javascript: showManufacturers('all');" value="all" <?php if ($params['products_from_manufacturers'] == 'all') { ?> checked="checked" <?php } ?> /><?php echo KaGlobal::t('All'); ?>&nbsp;&nbsp;
										<input type="radio" name="products_from_manufacturers" onclick="javascript: showManufacturers('selected');" value="selected" <?php if ($params['products_from_manufacturers'] == 'selected') { ?> checked="checked" <?php } ?> /><?php echo KaGlobal::t('Selected'); ?>
								</td>
							</tr>
							<tr id="export_selected_manufacturers" <?php if ($params['products_from_manufacturers'] != 'selected') { ?>style="display:none" <?php } ?>>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Manufacturers'); ?></label></td>
								<td colspan="2">
										<div class="well well-sm scrollbox">
											<?php $class = 'odd'; ?>
					...
					<div class="tab-pane" id="tab-advanced">
						<table class="table table-condensed table-striped table-hover">
							<tr>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Category Separator'); ?></label></td>
								<td colspan="2">
									<input type="text" name="cat_separator" maxlength="8" size="8" value="<?php echo $params['cat_separator']; ?>" />
								</td>
							</tr>
							<tr>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Image Path'); ?></label></td>
								<td>
									<select name="image_path" style="width:300px;">
										<option value="path" <?php if ($params['image_path'] == 'path') { ?>selected="selected"<?php } ?>><?php echo KaGlobal::t('Server Path'); ?></option>
										<option value="url" <?php if ($params['image_path'] == 'url') { ?>selected="selected"<?php } ?>><?php echo KaGlobal::t('URL'); ?></option>
									</select>                
								</td>
								<td width="50%">&nbsp;</td>
							</tr>
							<tr>
								<td width="25%"><label class="control-label"><span data-toggle="popover" data-content="<?php echo KaGlobal::t('it may be used when the exp...'); ?>"><?php echo KaGlobal::t('Copy the exported file to'); ?></span></label></td>
								<td colspan="2">
									<?php echo $store_root_dir . DIRECTORY_SEPARATOR; ?> <input type="text" name="copy_path" value="<?php echo $params['copy_path'];?>" /><br />
								</td>
							</tr>
							<tr>
								<td width="25%"><label class="control-label"><span data-toggle="popover" data-content="This is just a tip on how to configure automatic export. It is not an option."><?php echo KaGlobal::t('Automatic export schedule'); ?></span></label></td>
								<td colspan="2">
					...
					<div class="tab-pane" id="tab-extra">
						<table class="table table-condensed table-striped table-hover">
							<tr>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Currency'); ?></label></td>
								<td>
							...
							<tr>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Apply Taxes to Prices'); ?></label></td>
								<td>
							...
							<?php if (!empty($geo_zones)) { ?>
								<tr id="geo_zone_select" <?php if (empty($params['apply_taxes'])) { ?> style="display: none" <?php } ?>>
									<td width="25%"><?php echo KaGlobal::t('Use Taxes for Geo Zone'); ?></td>
									<td>
							...
							<tr>
								<td width="25%"><label class="control-label"><span data-toggle="popover" data-content="<?php echo KaGlobal::t('main product price will be ...'); ?>"><?php echo KaGlobal::t('Use special/discounted price'); ?></span></label></td>
								<td>
							...
							<?php if (!empty($customer_groups)) { ?>
								<tr id="customer_group_select" <?php if (empty($params['use_special_price'])) { ?> style="display: none" <?php } ?>>
									<td width="25%"><?php echo KaGlobal::t('Use Prices for Customer Group'); ?></td>
									<td>
							...
							<tr>
								<td width="25%"><label class="control-label"><span data-toggle="popover" data-content="the checkbox allows to skip products with 'disabled' status"><?php echo KaGlobal::t('Exclude inactive products'); ?></span></label></td>
								<td>
							...
							<tr>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Exclude products with zero quantity'); ?></label></td>
								<td>
							...
							<tr>
								<td width="25%"><label class="control-label"><?php echo KaGlobal::t('Export weight/length units separately'); ?></label></td>
								<td>
...
//--></script> 
  ...
  <?php } elseif ($params['step'] == 2) { ?>
		...
		<div class="page-header">
			<div class="container-fluid">
				<div class="pull-right">
					<button type="submit" form="form-input" data-toggle="tooltip" title="<?php echo KaGlobal::t('Next'); ?>" class="btn btn-primary"><?php echo KaGlobal::t('Next'); ?></button>
					<a onclick="location='<?php echo $back_action; ?>'" class="btn btn-default"><span><?php echo KaGlobal::t('Cancel'); ?></span></a>
				</div>
				<h1><?php echo $heading_title; ?>: <?php echo KaGlobal::t('STEP 2 of 3'); ?></h1>
				<?php echo $ka_breadcrumbs; ?>
			</div>
		</div>
        ...
        <input type="hidden" name="mode" value="" />
	      ...
	      <div class="tab-content">
  		    <div class="tab-pane active" id="tab-general">
						...
						<?php echo KaGlobal::t('Check fields to include the...'); ?><br /><br />
		        <table class="table table-condensed table-condensed table-striped table-hover">
							<thead>
								<tr>
									<td class="left" width="25%"><?php echo KaGlobal::t('Product Field'); ?></td>
									<td><?php echo KaGlobal::t('Column in File'); ?></td>
									<td>Include <br />(<a class="link" href="javascript: void(0);" onclick="javascript: $('input[name^=&quot;columns[general]&quot;]:checkbox').prop('checked', true);"><?php echo KaGlobal::t('all'); ?></a>
									/ <a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[general]&quot;]').not('[disabled=&quot;disabled&quot;]').prop('checked', false);"><?php echo KaGlobal::t('none'); ?></a>)</td>
									<td width="50%"><?php echo KaGlobal::t('Notes'); ?></td>
								</tr>
							</thead>
							...
							?>
								<tr>
									...
									<td>
										<input type="input" value="<?php echo $v['column']; ?>" name="columns[general][<?php echo $k; ?>][column]" />
									</td>
									<td>
										<input type="checkbox" value="Y" name="columns[general][<?php echo $k; ?>][checked]" 
											<?php if (!empty($v['required'])) { ?> disabled="disabled" <?php } ?> 
											<?php if (!empty($v['required']) || !empty($columns['general'][$k]['checked'])) { ?> checked="checked" <?php } ?> 
										/>
									</td>
	        ...
	        <div class="tab-pane" id="tab-attributes">
						<?php echo KaGlobal::t('Check attributes to include...'); ?><br /><br />
						<table class="table table-condensed table-striped table-hover">
							<thead>
								<tr>
									<td class="left" width="25%"><?php echo KaGlobal::t('Atribute Name'); ?></td>
									<td><?php echo KaGlobal::t('Column in File'); ?></td>
									<td><?php echo KaGlobal::t('Include'); ?> <br />(<a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[attributes]&quot;]').prop('checked', true);"><?php echo KaGlobal::t('all'); ?></a>
									/ <a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[attributes]&quot;]').not('[disabled=&quot;disabled&quot;]').prop('checked', false);"><?php echo KaGlobal::t('none'); ?></a>)</td>
									<td width="5%"><?php echo KaGlobal::t('Attribute Group'); ?></td>
								</tr>
							</thead>
					...
					<div class="tab-pane" id="tab-filters">
						<?php echo KaGlobal::t('Check filters to include th...'); ?><br /><br />
						<table class="table table-condensed table-striped table-hover">
							<thead>
								<tr>
									<td class="left" width="25%"><?php echo KaGlobal::t('Filter Group'); ?></td>
									<td><?php echo KaGlobal::t('Column in File'); ?></td>
									<td><?php echo KaGlobal::t('Include'); ?> <br />(<a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[filter_groups]&quot;]').prop('checked', true);"><?php echo KaGlobal::t('all'); ?></a>
									/ <a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[filter_groups]&quot;]').not('[disabled=&quot;disabled&quot;]').prop('checked', false);"><?php echo KaGlobal::t('none'); ?></a>)</td>
									<td width="5%">&nbsp;</td>
								</tr>
							</thead>
					...
					<div class="tab-pane" id="tab-options">
						<?php echo KaGlobal::t('Check options to include th...'); ?><br /><br />
						<table class="table table-condensed table-striped table-hover">
							<thead>
								<tr>
									<td class="left" width="25%"><?php echo KaGlobal::t('Option Name'); ?></td>
									<td><?php echo KaGlobal::t('Column in File'); ?></td>
									<td><?php echo KaGlobal::t('Include'); ?> <br />(<a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[options]&quot;]').prop('checked', true);"><?php echo KaGlobal::t('all'); ?></a>
									/ <a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[options]&quot;]').not('[disabled=&quot;disabled&quot;]').prop('checked', false);"><?php echo KaGlobal::t('none'); ?></a>)</td>
									<td width="50%"><?php echo KaGlobal::t('Type'); ?></td>
								</tr>
							</thead>
					...
					<div class="tab-pane" id="tab-discounts">
						<?php echo KaGlobal::t('Check discounts to include ...'); ?><br /><br />
						<table class="table table-condensed table-striped table-hover">
							<thead>
								<tr>
									<td class="left" width="25%"><?php echo KaGlobal::t('Field'); ?></td>
									<td><?php echo KaGlobal::t('Column in File'); ?></td>
									<td><?php echo KaGlobal::t('Include'); ?> <br />(<a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[discounts]&quot;]').prop('checked', true);"><?php echo KaGlobal::t('all'); ?></a>
									/ <a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[discounts]&quot;]').not('[disabled=&quot;disabled&quot;]').prop('checked', false);"><?php echo KaGlobal::t('none'); ?></a>)</td>
									<td width="50%"></td>
								</tr>
							</thead>
	        ...
	        <div class="tab-pane" id="tab-specials">
						<?php echo KaGlobal::t('Check special prices to inc...'); ?><br /><br />
						<table class="table table-condensed table-striped table-hover">
							<thead>
								<tr>
									<td class="left" width="25%"><?php echo KaGlobal::t('Field'); ?></td>
									<td><?php echo KaGlobal::t('Column in File'); ?></td>
									<td><?php echo KaGlobal::t('Include'); ?> <br />(<a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[specials]&quot;]').prop('checked', true);"><?php echo KaGlobal::t('all'); ?></a>
									/ <a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[specials]&quot;]').not('[disabled=&quot;disabled&quot;]').prop('checked', false);"><?php echo KaGlobal::t('none'); ?></a>)</td>
									<td width="50%"></td>
								</tr>
							</thead>
					...
					<div class="tab-pane" id="tab-reward_points">
						<?php echo KaGlobal::t('Check reward points to incl...'); ?><br /><br />
						<table class="table table-condensed table-striped table-hover">
							<thead>
								<tr>
									<td class="left" width="25%"><?php echo KaGlobal::t('Field'); ?></td>
									<td><?php echo KaGlobal::t('Column in File'); ?></td>
									<td><?php echo KaGlobal::t('Include'); ?> <br />(<a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[reward_points]&quot;]').prop('checked', true);"><?php echo KaGlobal::t('all'); ?></a>
									/ <a class="link" href="javascript: void(0);" onclick="javascript: $('[name^=&quot;columns[reward_points]&quot;]').not('[disabled=&quot;disabled&quot;]').prop('checked', false);"><?php echo KaGlobal::t('none'); ?></a>)</td>
									<td width="50%"></td>
								</tr>
							</thead>
...
//--></script> 
  ...
  <?php } elseif ($params['step'] == 3) { ?>
		...
		<div class="page-header">  
				<div class="container-fluid">
						<div class="pull-right" id="buttons_in_progress">
							<button class="btn btn-primary" onclick="javascript: ka_stop_export();" class="button"><?php echo KaGlobal::t('Stop'); ?></button>
						</div>
						<div class="pull-right" id="buttons_stopped" style="display: none">
							<button class="btn btn-primary" onclick="javascript: ka_continue_export();" class="button"><?php echo KaGlobal::t('Continue'); ?></button>
						</div>
						<div class="pull-right" id="buttons_completed" style="display: none">
							<button class="btn btn-primary" onclick="location='<?php echo $done_action; ?>'" class="button"><?php echo KaGlobal::t('Done'); ?></button>
						</div>							
      ...
      <h2 id="export_status"><?php echo KaGlobal::t('Export is in progress'); ?></h2>
			<table class="table table-striped table-hover">
				<tr>
					<td colspan="2"><?php echo KaGlobal::t('The export statistics updat...'); ?></td>
				</tr>
				<tr>
					<td width="25%"><?php echo KaGlobal::t('Completion at'); ?></td>
					<td id="completion_at">0%</td>
				</tr>
				<tr>
					<td width="25%"><?php echo KaGlobal::t('File Size'); ?></td>
					<td id="file_size">0</td>
				</tr>
				<tr>
					<td width="25%"><?php echo KaGlobal::t('Time Passed'); ?></td>
					<td id="time_passed">0</td>
				</tr>
				<tr>
					<td width="25%"><?php echo KaGlobal::t('Lines Processed'); ?></td>
					<td id="lines_processed">0</td>
				</tr>
				<tr>
					<td width="25%"><?php echo KaGlobal::t('Products Processed'); ?></td>
					<td id="products_processed">0</td>
				</tr>

				<tr id="download_row" style="display: none">
					<td colspan="2" style="text-align: center">
						<a class="download" href="<?php echo $download_link; ?>"><?php echo KaGlobal::t('download'); ?></a>
					</td>
				</tr>
				<tr>
					<td colspan="2">
						<h4><?php echo KaGlobal::t('Export messages'); ?>:</h4>
						<div class="scroll" id="scroll">
						</div>
						<input type="checkbox" id="autoscroll" checked="checked" /> <?php echo KaGlobal::t('Autoscrolling'); ?>
					</td>
				</tr>
    	</table>
  	</div>
...
function ka_update_interface(status) {
  ...
  if (status == 'stopped') {
    $("#export_status").html("<?php echo KaGlobal::t('Export stopped'); ?>");
    $("#buttons_stopped").show();

  } else if (status == 'completed') {
    $("#buttons_completed").show();
    $("#export_status").html("<?php echo KaGlobal::t('Export is complete!'); ?>");
    $("#download_row").show();
  
  } else if (status == 'in_progress') {
    $("#export_status").html('<?php echo KaGlobal::t('Export is in progress'); ?>');
...
function ka_stop_export() {
  ...
  $("#export_status").html('<?php echo KaGlobal::t('Export has been stopped'); ?>');
...
function ka_ajax_error(jqXHR, textStatus, errorThrown) {
  ...
  if ($.inArray(textStatus, ['abort', 'parseerror', 'error'])) {
    ...
    if (jqXHR.status == '200') {
      ka_add_message("<?php echo KaGlobal::t('Server error (status='); ?>200). Details:" + jqXHR.responseText);
    } else {
      ka_add_message("<?php echo KaGlobal::t('Server error (status='); ?>" + jqXHR.status + ").");
    }
    ka_update_interface('stopped');
  } else {
    ka_add_message('<?php echo KaGlobal::t('Temporary connection problems.'); ?>');
  }
...
function ka_export_loop() {
  ...
  if ($.inArray(ka_export_status, ['in_progress']) >= 0) {
    ...
    if (ka_dots == 0) {
      status_text = "<?php echo KaGlobal::t('Export is in progress'); ?>";
    } else {
